...
layui.define(['form', 'table'], function (exports) {
  //加载组件所需样式
  layui.link(jbasePath + '/layui/opTable/opTable.css', function () {
  }, 'opTable');
  // 加载列配置可拖动
  layui.$("body").append('<script type="text/javascript" src="' + jbasePath + '/layui/opTable/Sortable.min.js" charset="utf-8"></script>');
