...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header top">
        <div class="layui-logo"><img src="<%=basePath%>img/bg/logo.png" style="padding-left: 30px;"></div>
        ...
        <div style="padding-top: 12px;padding-left: 300px;"><label style="color: white; font-size: 30px; font-family: KaiTi; font-weight: bolder;">飞宏物料质量检验资料上传系统</label></div>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree nav" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    <a href="javascript:;"> <i class="layui-icon" style="margin-right: 10px;">&#xe681;</i>上传</a>
                    <dl class="layui-nav-child"  style="padding-left: 10px">
                        <dd><a href="#" data-id="4" data-title="文件上传" class="site-demo-active"
                               data-url="<%=basePath%>file/jumpUpload?userId=${user.userId}" data-type="tabAdd"> <i class="layui-icon">&#xe623;</i>文件上传</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="" href="javascript:;"> <i class="layui-icon" style="margin-right: 10px;">&#xe672;</i>审核管理</a>
                    <dl class="layui-nav-child"  style="padding-left: 10px">
                        <dd><a href="#" data-id="1" data-title="已上传列表" class="site-demo-active"
                               data-url="<%=basePath%>file/jumpUserFileInfo?account=${user.userId}" data-type="tabAdd">
                            <i class="layui-icon">&#xe623;</i>已上传列表</a></dd>
                    </dl>
                </li>
            </ul>
        </div>
